...
public class HomePageEntrepriseController implements Initializable {
    ...
    }private void createJobPost(ActionEvent actionEvent) {
        try {
            // Load the FXML file for the child window
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("ChildWindows/ChildWindowCreateJobPost.fxml"));
            Parent root = fxmlLoader.load();
            ...
            stage.setResizable(false);
            stage.initModality(Modality.APPLICATION_MODAL);
            stage.setTitle("Create a job offer");
